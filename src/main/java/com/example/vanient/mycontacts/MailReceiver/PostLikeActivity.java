...
public class PostLikeActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = "LIKE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.getSupportActionBar().setTitle("Like");

        send = findViewById(R.id.bt_like);
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.i(LOG_TAG, "Like Button Clicked.");
    ...
    private void sendEmail(final String accType) {
        lAuthState.performActionWithFreshTokens(lAuthorizationService, new AuthState.AuthStateAction() {
            ...
            public void execute(
                ...
                Log.i(LOG_TAG, String.format("Sending email like from " + senderMail + " with [Access Token: %s, ID Token: %s]", accessToken, idToken));

                new SendMailTask(PostLikeActivity.this).execute(senderMail,
                        accessToken, toEmailList, "---LIKE", "I like this post! :)\n-------------------------------------------\n" + originalpostBody, "null", accType);
