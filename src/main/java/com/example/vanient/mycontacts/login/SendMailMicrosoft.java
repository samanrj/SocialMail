...
public class SendMailMicrosoft {

    final String emailPort = "587";// outlook.com smtp port
    final String emailHost = "smtp-mail.outlook.com";
    ...
    public SendMailMicrosoft(String fromEmail, String fromPassword,
